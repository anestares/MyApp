<%-- 
    Document   : index.jsp
    Created on : 4 nov. 2020, 21:24:04
    Author     : USUARIO
--%>
        ...
        <div class="page-container">
            ...
            <div class="sidebar-menu">
                <div class="sidebar-header">
                    ...
                    <br>
                    <h6 class="text-center" style="color: aliceblue"><i class="fa fa-user"></i> <strong>Aldo Nestares</strong></h6>
                </div>
                <div class="main-menu">
                                    ...
                                    <form id="FrmCategoria">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <button type="submit" id="btnBuscarCategoria" class="btn btn-primary btn-xs mr-3">BUSCAR</button>
                                                <button type="button" id="btnAbrirNCategoria" class="btn btn-primary btn-xs"><i class="fa fa-plus-square"></i></button>
                                            </div>
                                        </div>                                            
                                    </form>
                                    <div class="row">
            ...
            <footer>
                <div class="footer-area">
                    <p>© Copyright 2020 <a href="#">Aldo Nestares</a>.</p>
                </div>
            </footer>
            <!-- footer area end-->
        </div>
